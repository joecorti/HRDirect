...
INDEL_NT_DISTRIBUTION=$BIN_DIR/Indel_median-freq_from_N-T
SNV_NT_DISTRIBUTION=$BIN_DIR/SNV_median-freq_from_N-T
export INDEL_NT_DISTRIBUTION SNV_NT_DISTRIBUTION BIN_DIR
...
RECALIBRATE=$FILES_DIR/recalibrateC/
