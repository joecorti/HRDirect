...
res <- vcfToSNVcatalogue(SNV_vcf_file ,genome.v = "hg19")
...
## ascat CN (lo fa automaticamente dentro "HRDetect_pipeline")
#ascat.data <- read.table(CNV_tab_file,header=TRUE, sep='\t')
#ascat.df = ascatToHRDLOH(ascat.data, sample_name)
